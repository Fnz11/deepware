...
@section('title', 'Laporan Pelatihan - BKPSDM')
                ...
                <table class="table table-hover align-middle">
                    <thead>
                        <tr class="border-bottom bg-light-primary text-muted fw-bold">
                            ...
                            <th class="min-w-200px">Waktu Pelaksanaan</th>
                            <th class="min-w-150px text-center">Surat Tugas</th>
                        </tr>
                    </thead>
                    <tbody>
                        @php
