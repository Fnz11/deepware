    ...
    <section>
        <div class="bg-primary text-white p-4 position-relative overflow-hidden bg-primary-section mb-2">
            ...
            <div class="container position-relative">
                <h4 class="fw-bold mb-2">Data Nomenklatur</h4>
            </div>
        </div>
        ...
        <div class="row mb-3 align-items-center">
            <div class="col-md-2 mt-2">
                <select class="form-select" id="rumpun">
                    ...
                    <option value="BKPSDM">Teknologi</option>
                    <option value="Kemenkes">Kesehatan</option>
                    <option value="Kominfo">Kepemimpinan</option>
                    <option value="Kemenag">Keterampilan</option>
                </select>
            </div>
                        ...
                        @php
                            ...
                            $kompetensi = [
                                [
                                    ...
                                    'Keterangan' =>
                                        'usulan nomenklatur ditolak dengan alasan sudah ada pelatihan dengan nama yang asma yaitu Pelatihan Kesehatan kepada Masyarakat',
                                    'Status' => 'Ditolak',
                                ],
                                [
                                    'Tahun' => '2025',
