...
class DeepwarePelatihansController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('Dashboard.Pelatihan.daftar-pelatihan')->with('success', 'Pelatihan created successfully.');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Redirect to the pelatihan index with success message
        return redirect()->route('Dashboard.Pelatihan.daftar-pelatihan')->with('success', 'Pelatihan updated successfully.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        // Redirect to the pelatihan index with success message
        return redirect()->route('Dashboard.Pelatihan.daftar-pelatihan')->with('success', 'Pelatihan deleted successfully.');
    }
