<div class="modal fade" id="modalEditPertanyaan" tabindex="-1" aria-labelledby="modalEditPertanyaanLabel" aria-hidden="true">
        ...
        <div class="modal-content rounded-4 shadow">
            <div class="modal-header border-0 pt-4 pb-1 px-4">
                <h5 class="modal-title fw-bold d-flex align-items-center">
                    ...
                    EDIT DATA PERTANYAAN AKPK
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form id="formEditPertanyaan" method="POST" action="{{ route('adminpertanyaandiri.update') }}">
                    @csrf
                    <input type="hidden" id="edit_id" name="id">
                    <div class="mb-3">
                        <label for="tipeSoal" class="form-label">Tipe Soal</label>
                        <select class="form-select" id="tipeSoal" name="tipe_soal" required>
                    ...
                    <div class="mb-3" id="pertanyaanField" style="display: none;">
                        <label for="pertanyaan" class="form-label">Pertanyaan</label>
                        <textarea class="form-control" id="pertanyaan" name="pertanyaan" rows="3"></textarea>
                    </div>

                    <div id="skalaFields" style="display: none;">
