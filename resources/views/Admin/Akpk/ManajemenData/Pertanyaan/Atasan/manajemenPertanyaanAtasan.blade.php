    ...
    <div class="">
        ...
        <div class="bg-primary text-white p-4 position-relative overflow-hidden bg-primary-section">
            ...
            <div class="container position-relative">
                ...
                <p class="mb-0 opacity-75">Data pertanyaan Assessment Atasan untuk seluruh ASN Kota Surakarta.</p>
            </div>
        </div>
        <div class="mt-4">
            <!-- Filter dan Tombol -->
            ...
            <div class="table-responsive">
                ...
                @endforeach
                    ...
                    @include('Admin.Akpk.ManajemenData.Pertanyaan.Atasan.editPertanyaanAtasan')
                    @include('Admin.Akpk.ManajemenData.Pertanyaan.Atasan.tambahPertanyaanAtasan')
                @endsection
                ...
                <script>
                    ...
                    document.querySelectorAll('.toggle-status').forEach(function (checkbox) {
                        checkbox.addEventListener('change', function () {
                            ...
                            fetch("{{ route('pertanyaan.toggleStatusAtasan') }}", {
                                method: "POST",
                                headers: {
                    ...
                    document.querySelectorAll('.btn-hapus-pertanyaan').forEach(function (btn) {
                        btn.addEventListener('click', function () {
                            ...
                            if (confirm('Apakah Anda yakin ingin menghapus pertanyaan ini?')) {
                                fetch("{{ route('adminpertanyaanatasan.hapus') }}", {
                                    method: "POST",
                                    headers: {
                                        "X-CSRF-TOKEN": "{{ csrf_token() }}",
                                        "Content-Type": "application/json"
